...
class Task:
	...
	def setRuntimeEnvironment(self, rtes=None):
		if not rtes == None:
			for i in range(0, len(rtes)):
				self.xrslAttributes["runTimeEnvironment"].append("runTimeEnvironment")
				self.xrslAttributes["runTimeEnvironment"].append(rtes[i])
