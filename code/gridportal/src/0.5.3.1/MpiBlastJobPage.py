...
class MpiBlastJobPage(JobPage):
	...
	def onCreateNewTask(self):
		...
		return LapMpiBlast.MpiBlastTask(self.blastType)

	def onCreateNewJobForm(self, task):
	
		LapUtils.log.msg(self.blastType+"JobPage", "onCreateNewJobForm")
		
		form = LapWeb.Form(self, "testform", "MpiBlastJobPage"+self.blastType, "Create a "+self.blastType+" job")
