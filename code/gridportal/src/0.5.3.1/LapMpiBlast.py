...
#		xrslAttribs["arguments"] = "./run.sh"
		...
		xrslAttribs["runTimeEnvironment"] = "APPS/BIO/MPIBLAST-1.0"
...
#		envFile.close()
		...
		xrslAttribs = self.getXRSLAttributes()
		xrslAttribs["arguments"] = "-c\" \"mpirun -np {n_nodes}"
		xrslAttribs["arguments"] += " -machinefile $PBS_NODEFILE $MPIBLAST_PATH/mpiblast"
		xrslAttribs["arguments"] += " " + params
		xrslAttribs["arguments"] += " -p " + self.blastType
		xrslAttribs["arguments"] += " -i " + attribs["seqInputFile"]
		xrslAttribs["arguments"] += " -o blast_out.QUERY" + html
