...
class DocCreateCert(LunarcPage):
	...
	def writeContent(self):
		...
		<li><strong>Domain:</strong> the domain of your organization (usually that will be the part of your email address after the '@'. eg. <span id="accs">ntnu.no</span> for an email address like <span id="accs">marmat@ntnu.no</span>.
