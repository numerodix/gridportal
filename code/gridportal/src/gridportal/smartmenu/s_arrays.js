...
{Show:'create',U:'',T:'&nbsp; Create &nbsp;'}
	...
	[
	{U:'PL_MatlabJobPage',T:'Matlab...'},
	{Show:'mpiblast',U:'',T:'mpiBLAST &raquo;'}
	]
	);

		s_add(
		{N:'mpiblast',LV:3,MinW:130,T:'',L:'',P:false,S:s_CSSTop},
		[
		{U:'PL_MpiBlastJobPageblastp',T:'blastp...'},
		{U:'PL_MpiBlastJobPageblastn',T:'blastn...'},
		{U:'PL_MpiBlastJobPageblastx',T:'blastx...'},
		{U:'PL_MpiBlastJobPagetblastn',T:'tblastn...'},
		{U:'PL_MpiBlastJobPagetblastx',T:'tblastx...'}
		]
	);
