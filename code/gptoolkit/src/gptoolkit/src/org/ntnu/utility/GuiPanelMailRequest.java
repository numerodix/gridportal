...
class GuiPanelMailRequest extends JPanel {
	...
	private JPanel getInstructionsPanel() {
		JPanel instructions = GuiToolbox.getMultilineJLabel("Once you have created a certificate, you must request for it to be signed.\nThe way to do this is to mail your request to the Certificate Authority\nand request a signature. This form below does NOT send this email, it\nmerely shows what you should include in your message. Use your\nregular email client to send the message.\n \n");
